...
const config = {
  PORT: 6060, // 启动端口
  ADMIN_GITHUB_LOGIN_NAME: 'ruoruochen', //  github 登录的账户名 user
  GITHUB: {
  ...
  EMAIL_NOTICE: {
    ...
    subject: '蒻蒻陈的博客 - 您的评论获得新的回复！', // 主题
    text: '您的评论获得新的回复！',
    WEB_HOST: 'http://127.0.0.1:3000', // email callback url
  },
  TOKEN: {
    secret: 'chensecret', // secret is very important!
...
if (!devMode) {
  ...
  config.EMAIL_NOTICE.transporterConfig.auth = {
    user: 'chenhuan928928@163.com', // generated ethereal user
    pass: '123456XXX', // generated ethereal password 授权码 而非 密码
  }
  config.EMAIL_NOTICE.WEB_HOST = 'https://ruoruochen.fun'
}
